...
export default function AuthLeftSide() {
    return (
        <div className="hidden md:flex w-1/2 bg-slate-900 text-white flex-col justify-between p-10">
            <div>
            ...
            <div className="flex justify-center items-center flex-1">
                <div className="bg-slate-800/60 backdrop-blur-md p-12 rounded-3xl shadow-inner">
                    <CalendarCheck className="w-20 h-20 text-blue-400" />
                </div>
            </div>
